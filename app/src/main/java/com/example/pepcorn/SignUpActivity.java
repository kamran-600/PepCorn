...
import com.example.pepcorn.databinding.ActivitySignUpBinding;
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    ...
                                    finishAffinity();
                                    Toast.makeText(SignUpActivity.this, "Account Created & Login successfully", Toast.LENGTH_SHORT).show();
                                }
                                else
